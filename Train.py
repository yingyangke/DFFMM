...
if __name__=="__main__":
    ...
    print("===> New Model")
    model = DFFMM(Ch=28, stages=8, size=256)
    print("===> Setting GPU")
    ...
    parser = argparse.ArgumentParser(description="Spectral Compressive Imaging")
